...
def readChamberSpec():
    ...
    branch_1 = Branch( icf253, p_icf253, 160,   0,   0 )
    branch_2 = Branch( icf253, p_icf253, 160,   0, 180 )
    branch_3 = Branch( icf203, p_icf203, 150,   0,  90 )
    branch_4 = Branch( icf203, p_icf203, 150,  90,  90 )
    branch_5 = Branch( icf203, p_icf203, 150, 270,  90 )

    branch_list_0 = [ branch_1, branch_2, branch_3, branch_4, branch_5 ]

    branch_6 = Branch( icf114, p_icf114, 155, 180, 90 )
    branch_list_1 = [ branch_6 ]

    branch_7 = Branch( icf114, p_icf114, 155, 180, 90 )
    branch_list_1 = [ branch_7 ]

    node0 = Node( branch_list_0, 0, 0,   0 )
    node1 = Node( branch_list_1, 0, 0, -60 )
    node2 = Node( branch_list_2, 0, 0,  60 )
